//--------------------------------------------------------------------------
import { importCssRenderer } from './CSS3DRenderer';
...
class DomBillboardRenderer
{
    ...
    //--------------------------------------------------------------------------
    async init(canvas, container) {
        await SDK3DVerse.installExtension(SDK3DVerse_ThreeJS_Ext);

        const { CSS3DObject, CSS3DRenderer } = importCssRenderer(SDK3DVerse.threeJS.THREE);
    ...
    async enable(triggererEntity) {
        ...
        this.sdk.notifier.on('OnCamerasUpdated', this.onCamerasUpdated);
    ...
    disable() {
        ...
        this.sdk.notifier.off('OnCamerasUpdated', this.onCamerasUpdated);
